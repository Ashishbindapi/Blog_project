...
$limit = 3;
$offset = ($page - 1) * $limit;
$sql = "SELECT * FROM blog LEFT JOIN categories ON blog.category=
        categories.cat_id LEFT JOIN user ON blog.author_id=user.
        user_id WHERE blog_title like '%$keyword%' or blog_body like '%$keyword%' ORDER BY blog.publish_date DESC limit $offset,$limit";
                    ...
                    <div class="card shadow">
                        <div class="card-body d-flex blog_flex">
                            <div class="flex-part1">
                                <a href="single_post.php?id=<?= $result['blog_id'] ?>"> <img src="./admin/upload/<?= $result['blog_image'] ?>" width="100px"> </a>
                            </div>
